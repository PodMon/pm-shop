    ...
    return (
      <div className="col-xs-12 col-sm-4 col-lg-6 get-in-contact">
        <div className="email-form">
          <div className="email-form-header">Podere Montachello</div>
          <div className="email-form-subheader">Follow us!</div>
          <Components.Translation defaultValue="Follow us on Facebook and Instagram." i18nKey="seeWhatYouCanDo"/>
  ...
  renderSocialLinks() {
    return (
      <div className="col-xs-12 col-sm-2 col-lg-1 social">
        ...
        <div>
          <a href="https://twitter.com/Pod_Montachello" title="Twitter">
        ...
        <div>
          <a href="https://facebook.com/podere.montachello" title="Facebook">
        ...
        <div>
          <a href="https://instagram.com/podere.montachello" title="Instagram">
  ...
  renderBottomLine() {
    return (
      <div className="bottomline row">
        &copy;{"2016 PODERE MONTACHELLO S.S. Privacy & Terms"}
      </div>
    );
  }
